...
// Array Traversing means visiting each element of the array one by one, usually to read, update, or perform some operation on each element.
...
//     demo.innerHTML += `${i} index of array is ${data[i]} <br/>`;  //  Accessing Each Element
// }
